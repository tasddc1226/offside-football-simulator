...
import { useShellMainHeight } from '../hooks/useShellMainHeight.js';
...
export function ScreenTransition({
  ...
  // 레이아웃에 영향을 준다. 대신 `useShellMainHeight`가 `.os-shell-main`을 찾아 그 clientHeight에서
  ...
  useShellMainHeight(containerRef);
