...
2026-09-06 사용자(오너)가 오너 소유 Google 계정에 오프사이드 전용 Google Cloud
프로젝트를 생성하도록 승인했다. 다른 Google Cloud 프로젝트는 사용하거나 변경하지 않는다.
...
| 항목                                 | 값                                                                   |
| ------------------------------------ | -------------------------------------------------------------------- |
| Google Cloud 소유 계정 / 지원 연락처 | 오너 Google 계정(주소는 저장소에 적지 않는다)                        |
| 앱 이름                              | 오프사이드 (OFFSIDE)                                                 |
| 클라이언트 유형                      | 웹 애플리케이션                                                      |
...
- 기존 프로필의 연결 상태가 false → true로 바뀌었다.
  기존 선수, career revision **18**,
