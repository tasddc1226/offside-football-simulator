...
- 사전 확인: 20:34 현재 main `5086ad0`로 읽기 전용 preflight 실행(run 34117318240) — 결과는 아래 적용 항목에 기록. 운영 current API는 `svc_season_1` ACTIVE / 1.3.0 / 0.5.0 / endsAt null(20:32 확인).
