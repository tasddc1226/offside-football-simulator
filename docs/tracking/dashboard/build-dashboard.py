...
ETA = [
    ...
    ("9/7~", "Phase 7 운영·밸런스: 리뷰 후속 이슈 #140~#172(P1 #140 무출전 고착·#141 협상 버튼, P2 enum #142·결산 표 #143·승격 표기 #144·CTA 가림 #146·키보드 #149·대표팀 결과 #150), 이슈 #104·#105, Google 브랜딩 인증, Search Console·네이버 등록, staging 룰셋·팩 승격(1.3.0/0.5.0), 실사용자 플레이 시간 측정(D1), U-014 Workers Paid·U-004 Sentry·U-005 종이 플레이테스트. Phase 8 WORLD STAGE는 그 뒤"),
]
DECISIONS = [
