...
NOW = ("Phase 0·1·2 코드는 끝났고 Phase 2는 사용자 게이트(플레이테스트 U-005·LINE TEST 9/8 시작 예정, U-014·U-015)만 남았습니다. "
       "Phase 3(계약·이적)은 9/5 새벽 T-3-005 UI(PR #65)까지 머지돼 코드가 끝났습니다. Phase 4(부상·관계·평판·대표팀)는 T-4-001 타입, T-4-002 부상(PR #64), T-4-003 관계·감독·평판(PR #67)이 머지됐고, T-4-004 대표팀(PR #68, CI 녹색)이 리뷰 지적 2건을 고치는 중이며 T-4-005 화면·T-4-006 통합 검증은 미착수입니다. "
       "9/5 오전 오케스트레이션은 Claude 세션으로 복귀했고(9/4 저녁~9/5 오전은 Codex+Luna), 이후 코드 작업은 Claude Code Workflow의 Sonnet 5 에이전트가 전담하며 Claude는 검증·리뷰·머지(화면은 ego-browser 확인)를 맡습니다. 다음 웨이브 브리프 T-4-007(디자인 PR #66 재통합)·T-4-005·T-4-006과 결정 D-56~D-58은 작성됐고 #68 머지 직후 T-4-007 ‖ T-4-006(domain) → T-4-005 → T-4-006(e2e) 순으로 투입합니다. "
...
GLOSSARY = [
    ...
    ("워커", "Claude Code Workflow로 띄우는 Sonnet 5 에이전트(격리 worktree). 브리프대로 구현·PR. 동시 최대 3명 (9/4~9/5 오전은 Orca gpt-5.6-luna max)"),
...
ETA = [
    ...
    ("9/5~", "PR #68 머지 → T-4-007 디자인 PR #66 재통합 ‖ T-4-006 domain(3시즌 fixture·property) → T-4-005 Phase 4 화면 → T-4-006 e2e·세션 길이 → Phase 4 감사. 사용자: U-014·U-015(LINE TEST 9/8)·U-005"),
]
DECISIONS = [
