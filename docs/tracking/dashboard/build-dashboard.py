...
LAYERS = [
    ...
    ("web · ui", "React 화면",
     ...
     ["Phase 4 화면 SCR-016·018·021·022·024·032, 관계 수치 점진 공개 (T-4-005)",
      ...
      "[핫픽스] injury.spec poll textContent 타임아웃 — 반복 플레이크 원인 (T-4-020, PR #80 검증 중)"]),
