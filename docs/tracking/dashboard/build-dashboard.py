...
LAYERS = [
    ...
    ("web · ui", "React 화면",
     ...
     ["Phase 4 화면 SCR-016·018·021·022·024·032, 관계 수치 점진 공개 (T-4-005)",
      ...
      "SCR-020 RETURN 관계 문구·{manager} 서사 토큰 (T-4-016, 진행 중)",
