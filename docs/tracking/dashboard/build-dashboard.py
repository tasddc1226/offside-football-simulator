...
ETA = [
    ...
    ("9/5~", "T-4-007 검증·머지(PR preview ego-browser 확인) → T-4-005 Phase 4 화면 → T-4-006 e2e·세션 길이 → Phase 4 감사. 사용자: U-014·U-015(LINE TEST 9/8)·U-005"),
]
DECISIONS = [
