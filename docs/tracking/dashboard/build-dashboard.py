...
ETA = [
    ...
    ("9/7 18:31", "PR #174 머지(b76104a, 협상 결과 배너·사유 캡션·결과 패널 포커스, D-69). e2e 새 실패 2건은 main 재현으로 이슈 #180. 이슈 #141 닫힘 → T-7-007(서명 프리필·제안 카드) 투입"),
    ("9/7 18:37", "PR #181 머지(630637b, 룰셋 1.4.0 회복 규칙 도메인: 역할 수락 계약 반영·하향 거절 무벌점·미이행 로그 보존, 1.3.0 재생 불변). e2e 새 실패 0"),
