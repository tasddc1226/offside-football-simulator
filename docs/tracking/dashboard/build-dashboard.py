...
NOW = ("운영 서비스가 열렸습니다. 9/6 12:33 사용자 세션이 수동 Production Release 워크플로로 첫 운영 배포를 마쳤고(run 34009144236, 82a46fc, 기록 PR #111), web offside-lab.com·api api.offside-lab.com에서 시즌 1(svc_season_1, 테스트 시즌 아님, 종료일 미정)이 ACTIVE입니다. 운영 활성 룰셋 1.3.0·콘텐츠 팩 0.5.0. "
       ...
       "이어서 13:47까지 Sonnet 서브에이전트 6명이 서로 겹치지 않는 6개 프로필(GK·CB·WG·CM·ST·DM × 성별·국적·출발 카드·전략, 선수 생성은 잠금으로 직렬화)로 57시즌을 플레이했습니다: 핵심 루프 6/6 완주, DM 케이스는 17시즌·36세 자연 은퇴·Legacy 78·보관함까지 정합. 무출전 고착은 5/6 케이스(57시즌 중 20시즌)에서 재현돼 '원소속에 머무는 한 어떤 선택도 출전을 만들지 못하고 임대·이적으로만 회복'으로 조건이 좁혀졌고, 협상 버튼 무결과 4/6·enum 노출 4/6·#105 3/6, 결산 표 모순과 승격 기록 대비 리그 표기 불변이 새로 잡혔습니다(docs/qa/2026-09-07-production-six-cases, P1 2·P2 8·P3 10). 이슈화는 사용자 결정입니다.")
...
ETA = [
    ...
    ("9/7~", "Phase 7 운영·밸런스: 두 리뷰 후속(P1 원소속 무출전 탈출 수단·협상 결과 배너, P2 enum·#105·결산 표 모순·승격 표기·CTA 가림·키보드·대표팀 결과), 이슈 #104·#105, Google 브랜딩 인증, Search Console·네이버 등록, staging 룰셋·팩 승격(1.3.0/0.5.0), 실사용자 플레이 시간 측정(D1), U-014 Workers Paid·U-004 Sentry·U-005 종이 플레이테스트. Phase 8 WORLD STAGE는 그 뒤"),
]
DECISIONS = [
