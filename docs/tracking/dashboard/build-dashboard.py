...
LAYERS = [
    ...
    ("web · ui", "React 화면",
     ...
     ["Phase 4 화면 SCR-016·018·021·022·024·032, 관계 수치 점진 공개 (T-4-005)",
      ...
      "[핫픽스] e2e 헬퍼 정규식 `&interested=` 허용 — main 회귀 (T-4-019, 진행 중)"]),
