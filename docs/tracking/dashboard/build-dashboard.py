...
LAYERS = [
    ("domain", "결정론 시뮬레이터",
     ["시드 RNG·canonical hash·golden fixture",
      ...
      "감사 domain 수정 §1 RNG·§2 시장/계약·§3 임대 복귀 (T-4-012, Codex 통합 PR #85)"],
     []),
    ("content", "이벤트·룰셋 데이터",
     ["프로토타입 팩 0.1.0(이벤트 10개)",
      ...
      "감사 content: season.stats 파생·슬럼프 게이트·EVT-CON-010 phase·INJURY previewEffects 검증기 (T-4-015, PR #82→#85)",
      "RUMOUR 이적 창 진입 경로 D-63 (T-4-022, PR #85)"],
     []),
    ...
    ("web · ui", "React 화면",
     ["라우터·디자인 토큰·허브 빈 상태",
      ...
      "DEV 팩 오버라이드·라벨 함수·phase4-seeds (T-4-009, PR #84→#85)",
      "step 7 전부 거절 문구·휴대폰 탭 시장 사유 (T-4-014, PR #78→#85)",
      "SCR-020 RETURN 문구·{manager} 토큰 (T-4-016, PR #79→#85)",
      "season.spec:17 프리시즌 도착 허용 (T-4-021, PR #83→#85)",
      "Phase 4 화면 SCR-016·018·021·022·024·032 맥락 패널·점진 공개·실제 적용량 결과 카드 D-64 (T-4-005a/b/c·T-4-018, Codex 통합 PR #85)"],
     ["SCR-032 대표팀 자연 플레이 캡처 (출시 QA 잔여, D-62)"]),
