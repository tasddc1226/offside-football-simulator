...
NOW = ("Phase 0·1은 끝났고 Phase 2는 코드가 끝나 사용자 게이트(플레이테스트·LINE TEST)만 남았습니다. "
       "LINE TEST 준비 코드(T-2-012)가 정오에 머지됐고 운영 계획(T-2-013)도 썼습니다. 공개까지 남은 것은 staging 확인·예행(오케스트레이터)과 U-014·U-015(사용자)입니다. "
...
ETA = [
    ...
    ("9/4~", "staging svc_line_test 응답 확인 → 오케스트레이터 예행(FAST·CHAPTER 1시즌). T-3-002 뒤 T-3-003(명령·결산 배선), T-4-001 뒤 T-4-002·T-4-003. U-005 플레이테스트 뒤 T-2-010. Orca PR 게이트 유지 여부는 사용자 결정"),
]
DECISIONS = [
