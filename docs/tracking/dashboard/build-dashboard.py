...
ETA = [
    ...
    ("9/14 13:58", "T-7-017 career-sim 머지(PR #216 c78b6f1): 워커 1차 + 후속 2회(은퇴 심사 강제 처리·retireReason·CSV 결정론, 병렬 합치기 타입 수정). 1.5.0 기준선 200커리어: OVR 정점 33~36세, 은퇴 심사 14/200(나머지 49세까지 현역), 1부 도달 33%, 부상 1.24/시즌, 구단 이동 3.0회, 시즌 40% RESERVE·출전 점유 42%, LEGEND·ICON 155/200. 조정 목표는 사용자 확인 대기(룰셋 1.5.1)."),
