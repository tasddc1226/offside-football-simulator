...
ETA = [
    ...
    ("9/4", "#45 머지 → T-2-011 web 항목 → Phase 2 잔여 T-2-010(콘텐츠, U-005 대기). Phase 3·4 브리프 작성"),
]
DECISIONS = [
