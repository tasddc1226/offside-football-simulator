...
ETA = [
    ("2026-09-16 12:40", "열린 이슈 27건 분담 합의(Codex·Claude, 사용자 지시): A 출전 밸런스·B 첫 플레이·공통 파일 통합은 Codex/Sol, C 장기 콘텐츠 기획·검증·D 백로그·보드는 Claude(구현은 Sol). C 4건(#243·#246·#247·#169) 1.7.2/0.6.6 재판정·수용기준 이슈 코멘트 등록. 보드 '열린 이슈 분담' 표 신설."),
    ("2026-09-16 01:09", "1.7.2/0.6.6 운영 승격(dev 체크아웃 Claude 세션, D-82): #238 첫 계약 흐름 단축 dffe5b1·#240 승격 준비 1f18d06 → preflight 34992863238·deploy 34993007861. 플레이 리뷰 3세션·원작 조사로 이슈 #241~#259 19건 등록."),
    ("2026-09-15 18:51", "1.7.1/0.6.5 운영 승격(Codex): #236 은퇴 아카이브 롤백 결함(RelationshipLogEntry step 0 거부) 430b129·#237 FAST 사건 노출 회귀 73f82c2 → deploy 34955129986. Codex 운영 17시즌 플레이로 은퇴·새 사건 인수."),
    ("2026-09-15 17:05", "0.6.4 운영 활성화(Codex): T-7-034 사건 아크 #233 5b5ec03 → T-7-035 사건 모달 #234 e71c71c → T-7-036 활성화 #235 eb95aef, deploy 34945528602. 신규 커리어만 1.7.0/0.6.4, 기존 커리어 보존."),
    ("2026-09-15 13:27", "1.7.0/0.6.3 운영 승격(Codex, 사용자 승인): T-7-033 #232 533c3d4 → CI 34928535257·preflight 34928569134·deploy 34928791797. Legacy 상위 밴드 22.7%(목표 32%) 수치를 알고 재튜닝 없이 승인 — 활성화 전 재보정 게이트 해소."),
