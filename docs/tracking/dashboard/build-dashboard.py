...
NOW = ("Phase 0·1·2 코드는 끝났고 Phase 2는 사용자 게이트(플레이테스트 U-005·LINE TEST 9/8 시작 예정, U-014·U-015)만 남았습니다. "
       ...
       "9/4 저녁부터는 Codex(gpt-5.6-sol ultra)가 오케스트레이터를 맡고 구현은 Orca gpt-5.6-luna max 워커가 합니다. 디자인 PR #66(19개 화면 모바일 개편)은 #68 뒤 최신 main에 재통합합니다. "
...
GLOSSARY = [
    ...
    ("워커", "Orca의 gpt-5.6-luna reasoning max 세션. 워크트리 하나에서 브리프대로 구현. 동시 최대 3명"),
...
ETA = [
    ...
    ("9/5~", "PR #68 머지 → 디자인 PR #66 최신 main 재통합·머지 → T-4-005 화면 → T-4-006 3시즌 통합 검증 → Phase 4 감사. 사용자: U-014·U-015(LINE TEST 9/8)·U-005"),
]
DECISIONS = [
