...
ETA = [
    ...
    ("9/4~", "T-2-012 머지 뒤 T-3-006 투입, staging svc_line_test 확인, T-2-013. T-3-002 뒤 T-3-003(명령·결산 배선), T-4-001 뒤 T-4-002·T-4-003. U-005 플레이테스트 뒤 T-2-010"),
]
DECISIONS = [
