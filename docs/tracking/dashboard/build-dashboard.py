...
ETA = [
    ...
    ("9/3 새벽", "T-1-009 머지 → 온보딩부터 첫 계약까지 로컬 동작. 선수 성별·선호 포지션(T-1-016) 투입"),
    ("9/3 오전~오후", "설정·복구·삭제·법적 문서(T-1-012), 성별·선호 포지션(T-1-016) → Google 연결(T-1-013)·E2E 완료 조건(T-1-014)"),
    ("9/3 오후", "온보딩부터 첫 계약까지 클릭으로 이어지는 화면 시연 목표"),
]
DECISIONS = [
