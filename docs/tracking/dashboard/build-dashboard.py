...
LAYERS = [
    ...
    ("content", "이벤트·룰셋 데이터",
     ...
     ["감사 content 묶음: season.stats 파생·슬럼프 게이트·EVT-CON-010 phase·INJURY previewEffects 검증기 (T-4-015, 진행 중)"]),
