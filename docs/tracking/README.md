...
> run 34009144236(`82a46fc`)으로 첫 운영 배포, 9/7 01:51~01:52 `939fe48` 재배포, 9/7 21:50 `308f9bc` 재배포(Phase 7 1차 웨이브·핫픽스 13건, run 34123837271, 시즌 룰셋 1.3.0 유지), 9/14 12:43 `643cd2a` 재배포(실시간 플레이 중 배지 D-78, K리그식 룰셋 1.5.0/0.6.0 3차 승격, run 34803426999).
