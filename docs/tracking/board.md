...
| ID | 워커 | 시작 | 상태 |
|---|---|---|---|
| T-2-008 | Sonnet 5, Orca 워크트리 `T-2-008-chapter-screen` | 2026-09-03 | PR #44 리뷰 통과, 검증 체인 e2e 2건 실패(season.spec TOCTOU·chapter.spec 0분 시즌) → 수정 중(2026-09-04 01:29 터미널 재투입) |
| T-2-009 | Sonnet 5, Orca 워크트리 `T-2-009-season-result` | 2026-09-03 | PR #45 리뷰 통과(수정 0건), #44 머지 뒤 `MAIN UPDATED` 받아 main 머지·재검증 예정 — 대기 |
| T-2-011 | Sonnet 5, Orca 워크트리 `T-2-011-phase2-verify` | 2026-09-04 | 투입(Phase 2 완료 조건 9행 검증: fixture 3종·결정론·집계·B > A → web 항목은 #44·#45 머지 뒤) |
