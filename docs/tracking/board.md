...
| T-7-004 | web | 협상 결과 배너 항상 표시(`contract.tsx` `pending===null` 이른 반환 수정), `negotiationDisabledReason` 사유 캡션·`aria-describedby`, 결과 패널 포커스, 회복 안내 문구 정책값 기반 | in-progress | [브리프](briefs/T-7-004.md) 이슈 #141, D-69. port 5264 2026-09-07 14:51 사용자 승인 → Workflow Sonnet 5 투입(worktree 격리) |
| T-7-005 | web | 표시 라벨 정합: `relationshipReasonLabel`(PROMISE_BREACH 등 16키+LEGACY_+폴백), 챕터 TAG 제목(`프로_데뷔`→'데뷔 이후의 무대', 폴백 '핵심 경기'), 결산 표 "선발 등급 vs 계약 역할 약속" 분리 + 캡션 | in-progress | [브리프](briefs/T-7-005.md) 이슈 #142·#143·#105. port 5265 2026-09-07 14:51 사용자 승인 → Workflow Sonnet 5 투입(worktree 격리) |
| T-7-006 | ui | 액션 독 어포던스: 상단 페이드·그림자, `.os-shell-main` `scroll-padding-bottom`, 불투명 배경 (CSS만) | in-progress | [브리프](briefs/T-7-006.md) 이슈 #146. port 5266 2026-09-07 14:51 사용자 승인 → Workflow Sonnet 5 투입(worktree 격리) |
...
| T-7-008 | ui | RadioGroup Enter 키 선택(Radix 기본은 Space만) | in-progress | [브리프](briefs/T-7-008.md) 이슈 #149. port 5268 2026-09-07 14:51 사용자 승인 → Workflow Sonnet 5 투입(worktree 격리) |
| T-7-009 | web | 대표팀 챕터 결과 요약 섹션(판단 결과·효과·태그·데뷔, 스코어 꾸미지 않음) | in-progress | [브리프](briefs/T-7-009.md) 이슈 #150. port 5269 2026-09-07 14:51 사용자 승인 → Workflow Sonnet 5 투입(worktree 격리) |
