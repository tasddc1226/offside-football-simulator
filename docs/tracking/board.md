...
| T-7-010 | web | "승격"→"승격권" 문구 정합 + 결산 캡션(리그 이동 없음). 실제 리그 이동은 Phase 8 후보로 보류 | todo | [브리프](briefs/T-7-010.md) 이슈 #144, D-68. T-7-005 머지 뒤(`season-result.tsx`). port 5270 |
...
| T-7-012 | ui | `.os-eyebrow` 색 대비 axe 위반(12화면) 수정 + `check:contrast` 쌍 추가 | in-progress | [브리프](briefs/T-7-012.md) 이슈 #180. port 5273. 17:20 투입 (Workflow Sonnet 5) |
