...
|---|---|---|---|---|---|---|
| T-2-001 | domain + content | FootballSeason·CompetitionRecord·12 step 캘린더, START_SEASON·SETTLE_SEASON, ADVANCE 재정의, checkpoint·결정 예산 | Phase 1 종료 | 1 | in-progress | `T-2-001-season-structure`, [브리프](briefs/T-2-001.md) |
...
| ID | 워커 | 시작 | 상태 |
|---|---|---|---|
| T-2-001 | Sonnet 5, Orca 워크트리 `T-2-001-season-structure` | 2026-09-03 | 브리프 전달 |
