...
| T-7-013 | web | SCR-009 제안 비교 `<dl>` 구조 axe 위반(`definition-list`·`only-dlitems`) 수정 | in-progress | [브리프](briefs/T-7-013.md) 이슈 #180. port 5274. 17:20 투입 (Workflow Sonnet 5) |
