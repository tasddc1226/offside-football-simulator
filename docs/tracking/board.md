...
| ID | 워커 | 시작 | 상태 |
|---|---|---|---|
| T-2-004 | Sonnet 5, Orca 워크트리 `T-2-004-chapters` | 2026-09-03 | PR #41 리뷰 수정·main(PR #40) 머지 중 |
