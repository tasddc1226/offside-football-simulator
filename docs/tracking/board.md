...
| T-2-013 | docs | LINE TEST 운영 계획·기준선 양식·완료 조건 표 | T-2-012 | 4 | todo | T-2-012 머지(PR #49)로 착수 가능 — 오케스트레이터가 직접 작성 |
