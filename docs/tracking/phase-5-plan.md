...
아래 번호는 이 계획의 작업 제안이며 외부 작업 시스템에 자동 배정한 것이 아니다. T-5-001은 PR #70 검토 중이며, 사용자 후속 요청에 따라 해당 커밋 위의 별도 브랜치에서 T-5-002의 독립 Archive 코어에 착수했다. 공유 파일을 수정하는 실제 저장 통합은 별도로 남긴다.

| 작업    | 범위                                                                              | 선행 조건                               | 상태                                     |
| ------- | --------------------------------------------------------------------------------- | --------------------------------------- | ---------------------------------------- |
| T-5-001 | 통산 기록 projection, 정규화된 Legacy 가중합·밴드, 이미 충족된 엔딩 우선순위 해소 | 현재 SeasonResult                       | PR #70 검토 중, main 미통합              |
| T-5-002 | 통산·업적 정본, 불변 Archive, Legacy 버전·저장 계약                               | T-5-001, 공유 타입 변경 소유권 합의     | 독립 코어 로컬 검증 완료, 저장 통합 대기 |
