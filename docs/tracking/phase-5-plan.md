...
| ------- | ------------------------------------------------------------------------------ | -------------------------------------------------------- |
| T-5-002 | Archive+Legacy 원자 저장, D1/API owner GET, 복구·삭제, 버전/checksum 고정       | 구버전 hash/null binding 및 신규 1.1 API 재로드 확인 완료 |
| T-5-003 | 실제 압력 입력, 마지막 선택, RETIRE/terminal 명령 거부, 연령 회귀               | 신규 1.1 실제 커리어 은퇴·새로고침 확인 완료             |
