...
투입 순서: T-2-001 → T-2-002 → (T-2-003, T-2-006) → (T-2-004, T-2-005) → (T-2-007, T-2-008, T-2-009, T-2-014) → (T-2-010, T-2-011) → T-2-012 → T-2-013. 브리프는 Wave가 열리기 전에 미리 쓴다. 2026-09-03 밤 사용자 결정("속도 올리자"): 선행이 이미 머지된 작업은 Wave를 기다리지 않고 동시 워커 3명 상한 안에서 바로 투입한다 — T-2-007은 T-2-004·005와 병행. SCR-012는 T-2-008에서 T-2-007로 옮겼다(선행 T-2-002뿐).
