...
- 작성일: 2026-09-14 / 상태: 첫 병렬 구현 묶음 착수, 검증·구현 PR 대기
...
|---|---|---|
| T-7-022 | WP-01/02/03: domain·contracts·content·저장·리그 표 수직 연결 | 공유 계약 단독 소유, 원장·크기·재생·실제 브라우저 증거를 포함한 PR |
| T-7-023 | WP-04: 기존 저장 사실 기반 면담·부상·임대 후속 화면 | core 변경 없이 병렬 구현, 인과관계 기록이 부족한 부분은 별도 gap 보고 |
| T-7-024 | WP-06: 은퇴 회고·마일스톤 표시 | 기존 은퇴 화면 안에서 병렬 구현, dashboard 공통 mount는 수정하지 않음 |
