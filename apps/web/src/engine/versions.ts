...
export const ACTIVE_RULESET_VERSION = '3.2.0';
export const ACTIVE_CONTENT_PACK_VERSION = '0.11.0';
 ...
 * svc_kickoff와 같고, 룰셋·팩만 운영 승격 목표 manifest를 따른다(3.2.0/0.11.0 후보, 2026-09-21).
 */
