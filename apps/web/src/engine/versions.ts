...
export const ACTIVE_RULESET_VERSION = '1.7.0';
export const ACTIVE_CONTENT_PACK_VERSION = '0.6.4';
 ...
 * svc_kickoff와 같고, 룰셋·팩만 운영 승격 목표 manifest를 따른다(0.6.4 승격, 2026-09-15).
 */
