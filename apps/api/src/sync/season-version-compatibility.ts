 ...
 * 각각 이 목록에 포함되어야 한다(중간 미승격 후보도 보존한다).
 *
...
export const APPROVED_PRODUCTION_MANIFESTS: readonly VersionPair[] = Object.freeze([
  ...
  Object.freeze({ rulesetVersion: '1.7.0', contentPackVersion: '0.6.4' }),
  Object.freeze({ rulesetVersion: '1.7.1', contentPackVersion: '0.6.5' }),
  Object.freeze({ rulesetVersion: '1.7.2', contentPackVersion: '0.6.6' }),
  Object.freeze({ rulesetVersion: '1.7.3', contentPackVersion: '0.6.7' }),
  ...
  Object.freeze({ rulesetVersion: '3.1.0', contentPackVersion: '0.10.0' }),
  Object.freeze({ rulesetVersion: '3.2.0', contentPackVersion: '0.11.0' }),
  Object.freeze({ rulesetVersion: '3.3.0', contentPackVersion: '0.12.0' }),
  Object.freeze({ rulesetVersion: '3.4.0', contentPackVersion: '0.13.0' }),
  Object.freeze({ rulesetVersion: '3.5.0', contentPackVersion: '0.14.0' }),
]);
